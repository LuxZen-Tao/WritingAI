...
NPC remembers useful objects it has seen
...
Search (rotate and scan)

Explore (move to new areas)

Move to Target

Move to Remembered Target
...
All world objects inherit from a base:
...
Defines if it can be used

Provides an interaction point

Can optionally satisfy a need

🔹 Room & Environment System
🏠 RoomArea

Defines environmental context
...
Natural light (e.g., sun through windows) is independent

Artificial light is controlled by switches
...
Environment-driven outcomes

Interruptible goals

Memory-informed decisions

Small rules → emergent behaviour
...
Social behaviours (multiple NPCs)
...
To build a scalable AI system where adding new:
...
naturally increases behavioural complexity without rewriting core logic.
