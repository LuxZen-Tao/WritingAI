...
=======
            ...
            {
                PopCurrentSubgoal("blocked door already open", out RouteSubgoal resolvedSubgoal);
                TryResumeParentGoalAfterSubgoal(resolvedSubgoal.originalDestination);
            }
...
=======
        ...
        {
            PopCurrentSubgoal("blocked door opened while pending", out RouteSubgoal resolvedSubgoal);
            TryResumeParentGoalAfterSubgoal(resolvedSubgoal.originalDestination);
        }
...
=======
    ...
    private bool PopCurrentSubgoal(string reason, out RouteSubgoal popped)
    {
        if (routeSubgoalStack.Count == 0)
        {
            popped = default;
        ...
        popped = routeSubgoalStack[routeSubgoalStack.Count - 1];
...
<<<<<<< ours
            ...
            return TryResumeParentGoalAfterSubgoal();
=======
            PopCurrentSubgoal("invalid top subgoal data", out RouteSubgoal poppedSubgoal);
            return TryResumeParentGoalAfterSubgoal(poppedSubgoal.originalDestination);
>>>>>>> theirs
        }
...
<<<<<<< ours
        ...
        if (routeCoordinator.IsSubgoalResolved(subgoal, controller))
        {
            ...
            return TryResumeParentGoalAfterSubgoal();
=======
            PopCurrentSubgoal("door no longer interactable", out RouteSubgoal poppedSubgoal);
            return TryResumeParentGoalAfterSubgoal(poppedSubgoal.originalDestination);
        }
        ...
        {
            PopCurrentSubgoal("top subgoal resolved", out RouteSubgoal poppedSubgoal);
            return TryResumeParentGoalAfterSubgoal(poppedSubgoal.originalDestination);
>>>>>>> theirs
        }
...
<<<<<<< ours
                ...
                return TryResumeParentGoalAfterSubgoal();
=======
                PopCurrentSubgoal("no reachable matching key found", out RouteSubgoal poppedSubgoal);
                return TryResumeParentGoalAfterSubgoal(poppedSubgoal.originalDestination);
>>>>>>> theirs
            }
...
=======
    ...
    private bool TryResumeParentGoalAfterSubgoal(Vector3? fallbackDestination)
    {
...
=======
        if (TryGetCurrentRouteObjective(out Vector3 destination) ||
            TryUseFallbackDestination(fallbackDestination, out destination))
>>>>>>> theirs
        {
...
<<<<<<< ours
=======
    private bool TryUseFallbackDestination(Vector3? fallbackDestination, out Vector3 destination)
    {
        if (!fallbackDestination.HasValue)
        {
            destination = transform.position;
            return false;
        }

        destination = fallbackDestination.Value;
        return true;
    }
